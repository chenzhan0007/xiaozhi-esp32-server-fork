// 配置管理模块
const DEFAULT_OTA_URL = "http://118.25.173.242:8003/xiaozhi/ota/";
const LEGACY_DEFAULT_OTA_URLS = [
  "http://127.0.0.1:8002/xiaozhi/ota/",
  "http://127.0.0.1:8003/xiaozhi/ota/",
  "http://localhost:8002/xiaozhi/ota/",
  "http://localhost:8003/xiaozhi/ota/",
];
...
export function loadConfig() {
  ...
  if (savedOtaUrl && !LEGACY_DEFAULT_OTA_URLS.includes(savedOtaUrl)) {
    otaUrlInput.value = savedOtaUrl;
  } else {
    otaUrlInput.value = DEFAULT_OTA_URL;
    localStorage.setItem("xz_tester_otaUrl", DEFAULT_OTA_URL);
  }
}
